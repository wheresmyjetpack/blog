...
module Dashboard
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['DASHBOARD_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Dashboard::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Dashboard::Action is included
      ...
      # Configure the code that will yield each time Dashboard::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Dashboard::Assets::Helpers
      end
    end
